...
namespace StopWatch
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.lblCreateAPIToken = new System.Windows.Forms.LinkLabel();
			this.SuspendLayout();
			// 
			// lblJiraBaseUrl
			// 
			...
			this.cbLoggingEnabbled.TabIndex = 7;
			...
			// lblCreateAPIToken
			// 
			this.lblCreateAPIToken.AutoSize = true;
			this.lblCreateAPIToken.Location = new System.Drawing.Point(256, 59);
			this.lblCreateAPIToken.Name = "lblCreateAPIToken";
			this.lblCreateAPIToken.Size = new System.Drawing.Size(92, 13);
			this.lblCreateAPIToken.TabIndex = 6;
			this.lblCreateAPIToken.TabStop = true;
			this.lblCreateAPIToken.Text = "Create API Token";
			this.lblCreateAPIToken.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.LblCreateAPIToken_LinkClicked);
			// 
			// SettingsForm
			// 
			...
			this.Controls.Add(this.lblCreateAPIToken);
		...
		private System.Windows.Forms.LinkLabel lblCreateAPIToken;
	}
}
